...
\f0\fs24 \cf0 /*\
  Marline Management Group \'97 lightweight SPA for GitHub Pages\
  - Hash-based routes (/#/path) so it works on static hosting.\
  - Update SITE_CONFIG below with your real info.\
*/\
\
const SITE_CONFIG = \{\
  businessName: "Marline Management Group",\
  tagline: "Back-office support for real estate, rentals, and short-term stays \'97 done right.",\
  cityLine: "Douglasville, GA",\
  phoneDisplay: "(000) 000-0000",\
  phoneTel: "+10000000000",\
  email: "hello@marlinemanagementgroup.com",\
  booking: \{\
    // If you use Calendly/Acuity, paste your scheduling link here\
    url: "",\
    // or embed HTML iframe code here (optional)\
    embedHtml: ""\
  \},\
  serviceArea: "Metro Atlanta & Remote",\
  brand: \{\
    // purely informational; actual colors live in CSS\
    primary: "Aqua/Purple Gradient"\
  \}\
\};\
\
const SERVICES = \{\
  "rental-property": \{\
    ...
    summary: "Operations support for long-term rentals\'97coordination, communication, and organization.",\
    includes: [\
    ...
    bestFor: [\
      "Small landlords",\
      "Busy professionals with 1\'9610 doors",\
      "Owners who want smoother operations and better documentation"\
    ]\
  \},\
  "property-management": \{\
    title: "Property Management",\
    summary: "Structured property coordination and reporting\'97built around clear workflows and accountability.",\
    includes: [\
  ...
  "real-estate-va": \{\
    ...
    summary: "Back-office relief for agents and teams\'97CRM, listing coordination, and transaction support.",\
    includes: [\
  ...
  "airbnb": \{\
    ...
    summary: "Guest messaging, turnover coordination, and issue escalation\'97so your listing stays smooth.",\
    includes: [\
...
function bookingHtml() \{\
  ...
  if (SITE_CONFIG.booking.url?.trim()) \{\
    ...
    return `\
      ...
      <p class="muted" style="margin:10px 0 0; font-size:13px;">Tip: If you prefer an embedded calendar, paste the iframe code into <code>SITE_CONFIG.booking.embedHtml</code> in <b>script.js</b>.</p>\
    `;\
  \}\
  // fallback\
  return `\
    <div class="notice">\
      Booking is not configured yet. Add your Calendly/Acuity link in <b>script.js</b> under <code>SITE_CONFIG.booking.url</code>.\
    </div>\
...
\
      <div class="section">\
        ...
        <p class="muted" style="margin-top:0;">Choose a service to see what\'92s included and how we get started.</p>\
      ...
      <div class="section">\
        <div class="cta-band">\
          <div>\
            ...
            <div class="muted">Book a quick consult and we\'92ll map the best next steps.</div>\
          </div>\
          <div>\
            <a class="btn btn-primary" href="#/book" data-nav>Book Appointment</a>\
          </div>\
...
\
        <div class="section split">\
          <div class="card">\
            <h2 class="h2">What\'92s included</h2>\
          ...
          <div class="card">\
            ...
            <div class="grid" style="grid-template-columns: repeat(3, 1fr); gap:14px; margin-top:12px;">\
              <div class="card" style="background:rgba(255,255,255,.03);">\
                ...
                <div class="muted">We confirm scope, property details (if relevant), and timeline.</div>\
              </div>\
              <div class="card" style="background:rgba(255,255,255,.03);">\
    ...
    <section class="section">\
      <div class="container">\
        <div class="card" style="padding:22px;">\
          ...
          <p class="lede">$\{escapeHtml(SITE_CONFIG.businessName)\} provides reliable administrative and operations support for real estate professionals, property owners, and short-term rental hosts. We blend responsiveness with systems\'97so tasks don\'92t just get done\'85 they get done consistently, documented, and on time.</p>\
      ...
      <div class="container">\
        <div class="split">\
          <div class="card" style="padding:22px;">\
            ...
            <h1 class="h1" style="font-size:34px;">Let\'92s talk.</h1>\
            <p class="lede">Send a message and we\'92ll respond with next steps. If your request is urgent, include your preferred callback time.</p>\
\
            <form class="form" id="contactForm">\
              ...
              <div class="notice" id="contactNote">This demo form uses your email client (mailto). You can switch to Formspree or a backend later.</div>\
            </form>\
          </div>\
\
          <div class="card" style="padding:22px;">\
            ...
            <p class="muted" style="margin-top:0;">$\{escapeHtml(SITE_CONFIG.cityLine)\} \'b7 $\{escapeHtml(SITE_CONFIG.serviceArea)\}</p>\
\
...
\
              <div class="notice">\
                <b>Note:</b> If your state requires a license for certain property management activities, we\'92ll tailor the wording and scope accordingly.\
              </div>\
            </div>\
\
          </div>\
...
\
function viewBook() \{\
  // Also opens modal automatically\
  return `\
    <section class="section">\
      <div class="container">\
        <div class="card" style="padding:22px;">\
          ...
          <p class="lede">Choose a time that works for you. If booking isn\'92t configured yet, you can contact us instead.</p>\
          <div class="hero-cta">\
    ...
    <section class="section">\
      <div class="container">\
        <div class="card" style="padding:22px;">\
          ...
          <p class="lede">That route doesn\'92t exist. Use the menu to navigate.</p>\
          <div class="hero-cta">\
...
\
  // Auto-open booking modal on book route\
  if (path === "book") \{\
...
function bindViewEvents() \{\
  ...
  $$('[data-book]').forEach(btn => \{\
    btn.addEventListener('click', () => \{\
      ...
      modal.open(`Book \'97 $\{svc\}`, bookingHtml());\
    \});\
  \});\
\
  // Book page\
...
\
      const subject = encodeURIComponent(`[MMG Inquiry] $\{service\} \'97 $\{name\}`);\
      const body = encodeURIComponent(\
        `Name: $\{name\}\\nEmail: $\{email\}\\nService: $\{service\}\\n\\nMessage:\\n$\{message\}\\n\\n\'97 Sent from marlinemanagementgroup.com`\
      );\
\
